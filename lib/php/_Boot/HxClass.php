...
class HxClass {
	...
	public function __construct ($phpClassName) {
		#/usr/share/haxe/std/php/Boot.hx:665: characters 3-35
	...
	public function __call ($method, $args) {
		#/usr/share/haxe/std/php/Boot.hx:673: characters 3-111
		$callback = ((($this->phpClassName === "String" ? HxString::class : $this->phpClassName))??'null') . "::" . ($method??'null');
		#/usr/share/haxe/std/php/Boot.hx:674: characters 3-53
	...
	public function __get ($property) {
		#/usr/share/haxe/std/php/Boot.hx:682: lines 682-690
		if (\defined("" . ($this->phpClassName??'null') . "::" . ($property??'null'))) {
			#/usr/share/haxe/std/php/Boot.hx:683: characters 4-54
			return \constant("" . ($this->phpClassName??'null') . "::" . ($property??'null'));
		} else if (Boot::hasGetter($this->phpClassName, $property)) {
			#/usr/share/haxe/std/php/Boot.hx:685: characters 29-41
			...
			#/usr/share/haxe/std/php/Boot.hx:689: characters 33-45
			$tmp = $this->phpClassName;
	...
	public function __set ($property, $value) {
		#/usr/share/haxe/std/php/Boot.hx:698: lines 698-702
		if (Boot::hasSetter($this->phpClassName, $property)) {
			#/usr/share/haxe/std/php/Boot.hx:699: characters 22-34
			$tmp = $this->phpClassName;
			#/usr/share/haxe/std/php/Boot.hx:699: characters 4-59
			$tmp::{"set_" . ($property??'null')}($value);
		} else {
			#/usr/share/haxe/std/php/Boot.hx:701: characters 26-38
			$tmp = $this->phpClassName;
			#/usr/share/haxe/std/php/Boot.hx:701: characters 4-56
			$tmp::${$property} = $value;
		}
	}
}
